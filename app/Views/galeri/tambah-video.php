...
<div class="w-full px-4 py-6">
    <div class="flex justify-between pb-4">
        <h1 class="font-bold text-3xl">Tambah Galeri Video</h1>
    ...
    <div class="container mt-6">
        <form action="<?= base_url('admin/galeri/save-video'); ?>" method="post" class="bg-white shadow-lg rounded-lg p-6 border">
            <?= csrf_field(); ?>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="link" id="link" class="input input-bordered w-full <?= isset(session()->get('validator')['link']) ? 'border-red-500' : 'border-gray-300'; ?>" value="<?= old('link'); ?>" onchange="preview()">
                ...
                <div class="mb-4 flex justify-center items-center">
                    <iframe
                        ...
                        width="260"
                        height="450"
                        src="<?= str_replace("shorts", "embed", old('link')) ?>"
                        title="Video Short"
                        frameborder="0"
