...
<div class="w-full px-4 py-2">
    <div class="flex justify-between pb-2">
        <h1 class="font-bold text-3xl items-center">Kelola Testimoni</h1>
        <p></p>
        <div class="text-sm place-self-end">
            <ul class="flex">
                ...
                <li class="font-medium"><span>Testimoni</span></li>
            </ul>
        </div>
    </div>
    ...
    <div class="container mt-4">
        <div class="flex items-center mb-4">
            <a href="<?= base_url('admin/testi/add'); ?>" class="flex items-center space-x-2 bg-primary text-white rounded-sm py-2 pr-3 pl-2 text-sm">
        ...
        <div class="card-body relative overflow-x-auto shadow-md border">
            <table class="w-full text-sm text-left text-gray-500 rounded-none">
                ...
                <tbody>
                    <?php if(!$data): ?>
                        <tr><td class="text-center pt-5" colspan="5">Belum ada data testimoni</td></tr>
                    <?php endif; ?>
                    ...
                    <?php foreach ($data as $key => $d) : ?>
                        <tr class="border-b">
                            ...
                            <th scope="row" class="px-6 py-4 font-medium whitespace-nowrap">
                                <img src="/uploaded/testimoni/<?= $d['image']; ?>" class="w-32">
                            </th>
                            <td class="px-6 py-4 flex space-x-2">
                                <a href="<?= base_url('admin/testi/edit/' . $d['id_testi']); ?>" class="btn btn-sm text-white btn-warning">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="m16.862 4.487 1.687-1.688a1.875 1.875 0 1 1 2.652 2.652L10.582 16.07a4.5 4.5 0 0 1-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 0 1 1.13-1.897l8.932-8.931Zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0 1 15.75 21H5.25A2.25 2.25 0 0 1 3 18.75V8.25A2.25 2.25 0 0 1 5.25 6H10" />
                                    </svg>
                                    <span>Edit</span>
                                </a>
                                <a href="<?= base_url('admin/testi/delete/' . $d['id_testi']); ?>" class="btn btn-sm text-white bg-red-500" onclick="return confirm('Apa anda yakin akan menghapus testimoni ini ?')">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
