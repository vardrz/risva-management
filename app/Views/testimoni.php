...
<html lang="en" data-theme="light">
  <head>
    ...
    <title>Testimoni - Risva Management</title>
...
>
  ...
  <div class="mx-auto max-w-4xl">
    ...
    <div class="prose max-w-none pt-8">
      <h3 id="lorem-ipsum-dolor-sit-amet">Dari <?= $testi['nama']; ?></h3>
      <p><?= $testi['pesan']; ?></p>

      <img src="<?= base_url('uploaded/testimoni/') . $testi['image']; ?>">
    </div>
    <a href="/#testimoni" class="flex items-center mt-8">
